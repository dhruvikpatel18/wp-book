...
{
    // register all the shortcode here.
    ...
    public function custom_book_shortcode( $attr ) {
        ...
        // check if id available and if yes then add it into the ids array
        if( isset( $attr['id'] ) ) {
            $ids[] = $attr['id'];
        }
        ...
        // get id of all the books from custom metatable 'wp_bookmeta' who has following author
        ...
        // get id of all the books from custom metatable 'wp_bookmeta' who has following year
        if( isset( $attr['year'] ) ) {
            global $wpdb;
        ...
        // get id of all the books from custom metatable 'wp_bookmeta' who has following publisher name
        ...
        if( $query->have_posts() ):
            ...
            while( $query->have_posts() ): $query->the_post();
                ...
                // get meta information of using book_id
